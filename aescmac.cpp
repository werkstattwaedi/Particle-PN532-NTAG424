...
void xor_block(uint8_t *output, const uint8_t *input1, const uint8_t *input2, size_t len) {
...
void AES128_CMAC(const uint8_t key[16], const uint8_t *input, size_t length, uint8_t output[16]) {
